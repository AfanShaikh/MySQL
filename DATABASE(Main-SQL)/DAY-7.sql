...
CREATE TABLE naruto (
    ...
    name VARCHAR(100),
    age INT,
    ninja_level VARCHAR(50)
);

INSERT INTO naruto (ranking, name, age, ninja_level) VALUES
(1, 'Naruto Uzumaki', 17, 'Genin'),
(2, 'Sasuke Uchiha', 17, 'Rogue Ninja'),
(3, 'Sakura Haruno', 17, 'Jonin'),
(4, 'Kakashi Hatake', 30, 'Hokage'),
(5, 'Minato Namikaze', 24, 'Hokage'),
(6, 'Jiraiya', 50, 'Sannin'),
(7, 'Tsunade', 51, 'Hokage'),
(8, 'Orochimaru', 55, 'Sannin'),
(9, 'Itachi Uchiha', 21, 'Anbu Captain'),
(10, 'Shikamaru Nara', 17, 'Jonin'),
(11, 'Neji Hyuga', 17, 'Jonin'),
(12, 'Rock Lee', 17, 'Chunin'),
(13, 'Gaara', 18, 'Kazekage'),
(14, 'Hinata Hyuga', 17, 'Chunin'),
(15, 'Kiba Inuzuka', 17, 'Chunin'),
(16, 'Sai', 17, 'Anbu'),
(17, 'Madara Uchiha', 90, 'Legendary Ninja'),
(18, 'Hashirama Senju', 100, 'First Hokage'),
(19, 'Tobirama Senju', 95, 'Second Hokage'),
(20, 'Obito Uchiha', 29, 'Rogue Ninja');
...
INSERT INTO dragon_ball (ranking, name, age, ninja_level) VALUES
(1, 'Goku', 43, 'Ultra Instinct'),
(2, 'Vegeta', 48, 'Super Saiyan Blue'),
(3, 'Gohan', 23, 'Ultimate Form'),
(4, 'Piccolo', 40, 'Namekian Warrior'),
(5, 'Trunks', 14, 'Super Saiyan'),
(21, 'Goten', 13, 'Super Saiyan'),
(22, 'Frieza', 70, 'Golden Form'),
(23, 'Cell', 35, 'Perfect Form'),
(24, 'Majin Buu', 500, 'God Level'),
(25, 'Beerus', 200, 'God of Destruction');
